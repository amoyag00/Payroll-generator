...
public class BankAccountCode {
    ...
    public BankAccountCode(String code){
        ...
        this.offEnt=this.oldCode.substring(0,8);/*Extract office and entity code */
        this.controlDigit1=this.oldCode.substring(8,9);/* Extract control digits*/
    ...
    /**
     * Calculates the control digits of the account code and updates it if
     * wrong.
    ...
    public boolean correct(){
        ...
        String correctCD=""; /* correct control digit */
